...
export default (initialState, { req, res }) => {
    ...
    res.send(
        '<!doctype html>\n' +
            ...
            "<style> html, body, .app-container { width: 100%; height: 100%; padding: 0; border: none; margin: 0; font-family: proxima-nova, \"Helvetica Neue\", Helvetica, Roboto, Arial, sans-serif} *:focus { outline: 0; } </style>" +
            '<script>\n' +
